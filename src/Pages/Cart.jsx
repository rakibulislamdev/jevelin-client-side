  ...
  return (
    <>
      ...
      <div className="text-[#e7e7e7] font-bold leading-none max-w-6xl mx-auto mb-10">
        <h5 className="lg:text-[56px] text-4xl">Your cart is <br /> <span className="uppercase lg:text-[110px] text-6xl">CURRENTLY</span> <br /> <span className="uppercase lg:text-[110px] text-6xl">EMPTY</span></h5>
      </div>
      </div>
    </>
  );
